...
<head>
    ...
    <title>Aplikasi Peduli lindungi - User</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="user.php">
                ...
                <div class="sidebar-brand-text mx-3">Peduli Diri <sup>Mifin</sup></div>
            </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    <h3>Aplikasi Pencatatan Perjalanan - Peduli Diri</h3>
                </nav>
                <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="mb-4 text-gray-800">
                        ...
                        if(!empty(@$_GET['url'])){
                            ...
                            echo "Selamat Datang Di Aplikasi Peduli Diri, Dimana Aplikasi ini digunakan mencatat perjalanan.";
                            echo "<br><br>";
